<template>
    <div class="careers">
        ...
        <Hero
            ...
            <h1>While learning from the best and brightest.</h1>
                        ...
                        <div class="wrapper">
                            ...
                            <div class="grid-x grid-padding-x jobs text-center align-center">
                                <div class="cell small-12 medium-8">
                                    ...
                                    <p>
                                        No matter where you're based in Australia, you’ll be part of a group of people working together to build solutions to mission-critical problems and a company that values the very best ideas. There’s a role here for you—whether you're a new grad or have years of experience.
                                    </p>
                                </div>
                            </div>
