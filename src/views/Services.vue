<template>
    <div class="services">
        ...
        <div class="grid-x grid-padding-x">
            <about-router class="small-12 cell"/>
            <careers-router class="small-12 cell"/>
        </div>
        <footer-view/>
    </div>
</template>
...
<style lang="scss" scoped>
    ...
    section.services {
        ...
        .service {
            ...
            width: 100%;
            background-color: $white;
            box-shadow: 0 10px 30px 0 rgba($navypurple-color, 0.1);
